...
import com.xcxyz.mini.dubbo.cluster.engine.ClusterEngine;
import com.xcxyz.mini.dubbo.config.center.zookeeper.IRegisterCenter4Invoker;
...
public class RevokerProxyBeanFactory implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        final MiniDubboRequest request = new MiniDubboRequest();
        //设置本次调用的唯一标识
        ...
        try {
            ...
            Future<MiniDubboResponse> responseFuture = fixedThreadPool.submit(RevokerServiceCallable.of(inetSocketAddress, request));
            //获取调用的返回结果
            MiniDubboResponse response = responseFuture.get(request.getInvokeTimeout(), TimeUnit.MILLISECONDS);
            if (response != null) {
